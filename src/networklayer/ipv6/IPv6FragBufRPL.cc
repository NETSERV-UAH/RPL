...
void IPv6FragBufRPL::init(ICMPv6RPL *icmp)
{
    icmpModule = icmp;
}

IPv6Datagram *IPv6FragBufRPL::addFragment(IPv6Datagram *datagram, IPv6FragmentHeader *fh, simtime_t now)
{
 ...
 *
 */
void IPv6FragBufRPL::purgeStaleFragments(simtime_t lastupdate)
{
