...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      <interface_config>
        ...
        <x>15.90709120765922</x>
        <y>21.89688259187673</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>19.765923640211028</x>
        <y>0.24455677159088363</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>14.527097788763184 0.0 0.0 14.527097788763184 -65.11268755750606 12.174572591467761</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>//TIMEOUT(180000, log.log("Not converged\n")); 
...
while (true) {
    ...
    if (msg.equals("Periodic Statistics: convergence time ended")) {
        //log.testOK();
        exit(0);
    }else if (msg.equals("check convergence")){
