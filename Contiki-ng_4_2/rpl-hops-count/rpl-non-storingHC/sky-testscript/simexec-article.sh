...
#Simulation list
SIMULATIONS=(002 005 010 015 020 025 050 100) #(002 005 010 015 020 025 050 100 200) #(002 005) #(002) #(005) #(010) #(015) #(020) #(050)

#Scenario list
SCENARIOS=(01 02 03 04 05 06 07 08 09 10) #(01) #(01 02)

cd ~/contiki-ng/examples/rpl-non-storingHC/sky-testscript
#Compile log parser
