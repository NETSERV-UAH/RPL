 ...
 *                    Develpoed on OMNeT++ 5.2.1 & INET 3.6.3 by using their proposed interfaces to adapt for using
 *                    in the RPL and other wireless protocols
*/
...
#ifndef __RPLSRC_PHYSICALLAYER_SIMPLEIDEALRADIO_SIMPLEIDEALRADIOMEDIUM_H
#define __RPLSRC_PHYSICALLAYER_SIMPLEIDEALRADIO_SIMPLEIDEALRADIOMEDIUM_H
...
#endif // ifndef __RPLSRC_PHYSICALLAYER_SIMPLEIDEALRADIO_SIMPLEIDEALRADIOMEDIUM_H
