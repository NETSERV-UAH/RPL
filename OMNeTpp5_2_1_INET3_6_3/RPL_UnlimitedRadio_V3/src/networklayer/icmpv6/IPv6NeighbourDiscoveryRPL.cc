...
Define_Module(IPv6NeighbourDiscoveryRPL);
...
void IPv6NeighbourDiscoveryRPL::initialize(int stage)
{
    ...
    if (stage == INITSTAGE_NETWORK_LAYER) {
        ...
        //icmpv6 = getModuleFromPar<ICMPv6RPL>(par("icmpv6Module"), this);  //EXTRA
        icmpv6 = check_and_cast<ICMPv6RPL *>(this->getParentModule()->getSubmodule("icmpv6")); //EXTRA
...
void IPv6NeighbourDiscoveryRPL::handleMessage(cMessage *msg)
{
    ...
    if (msg->isSelfMessage()) {
        ...
        //EXTRA BEGIN
        if (dynamic_cast<ICMPv6DISMsg *>(msg)) {
...
bool IPv6NeighbourDiscoveryRPL::handleOperationStage(LifecycleOperation *operation, int stage, IDoneCallback *doneCallback)
{
    throw cRuntimeError("Lifecycle operation support not implemented");
}

void IPv6NeighbourDiscoveryRPL::finish()
{
}

void IPv6NeighbourDiscoveryRPL::processIPv6Datagram(IPv6Datagram *msg)
{
...
IPv6NeighbourDiscoveryRPL::AdvIfEntry *IPv6NeighbourDiscoveryRPL::fetchAdvIfEntry(InterfaceEntry *ie)
{
...
IPv6NeighbourDiscoveryRPL::RDEntry *IPv6NeighbourDiscoveryRPL::fetchRDEntry(InterfaceEntry *ie)
{
...
const MACAddress& IPv6NeighbourDiscoveryRPL::resolveNeighbour(const IPv6Address& nextHop, int interfaceId)
{
...
void IPv6NeighbourDiscoveryRPL::reachabilityConfirmed(const IPv6Address& neighbour, int interfaceId)
{
...
IPv6Address IPv6NeighbourDiscoveryRPL::determineNextHop(const IPv6Address& destAddr, int& outIfID)
{
...
void IPv6NeighbourDiscoveryRPL::processNUDTimeout(cMessage *timeoutMsg)
{
...
IPv6Address IPv6NeighbourDiscoveryRPL::selectDefaultRouter(int& outIfID)
{
...
void IPv6NeighbourDiscoveryRPL::timeoutPrefixEntry(const IPv6Address& destPrefix,
...
void IPv6NeighbourDiscoveryRPL::timeoutDefaultRouter(const IPv6Address& addr,
        int interfaceID)
{
    //RFC 2461: Section 6.3.5
...
void IPv6NeighbourDiscoveryRPL::initiateAddressResolution(const IPv6Address& dgSrcAddr,
        Neighbour *nce)
{
    const Key *nceKey = nce->nceKey;
    InterfaceEntry *ie = ift->getInterfaceById(nceKey->interfaceID);
...
void IPv6NeighbourDiscoveryRPL::processARTimeout(cMessage *arTimeoutMsg)
{
...
void IPv6NeighbourDiscoveryRPL::dropQueuedPacketsAwaitingAR(Neighbour *nce)
{
    const Key *nceKey = nce->nceKey;
...
void IPv6NeighbourDiscoveryRPL::sendPacketToIPv6Module(cMessage *msg, const IPv6Address& destAddr,
...
void IPv6NeighbourDiscoveryRPL::sendQueuedPacketsToIPv6Module(Neighbour *nce)
{
    MsgPtrVector& pendingPackets = nce->pendingPackets;
...
void IPv6NeighbourDiscoveryRPL::processDADTimeout(cMessage *msg)
{
...
void IPv6NeighbourDiscoveryRPL::makeTentativeAddressPermanent(const IPv6Address& tentativeAddr, InterfaceEntry *ie)
{
...
IPv6RouterSolicitation *IPv6NeighbourDiscoveryRPL::createAndSendRSPacket(InterfaceEntry *ie)
{
...
void IPv6NeighbourDiscoveryRPL::initiateRouterDiscovery(cMessage *msg)
{
...
void IPv6NeighbourDiscoveryRPL::cancelRouterDiscovery(InterfaceEntry *ie)
{
...
void IPv6NeighbourDiscoveryRPL::processRDTimeout(cMessage *msg)
{
    InterfaceEntry *ie = (InterfaceEntry *)msg->getContextPointer();
    RDEntry *rdEntry = fetchRDEntry(ie);
...
void IPv6NeighbourDiscoveryRPL::processRSPacket(IPv6RouterSolicitation *rs,
...
bool IPv6NeighbourDiscoveryRPL::validateRSPacket(IPv6RouterSolicitation *rs,
        IPv6ControlInfo *rsCtrlInfo)
{
    bool result = true;
...
IPv6RouterAdvertisement *IPv6NeighbourDiscoveryRPL::createAndSendRAPacket(const IPv6Address& destAddr, InterfaceEntry *ie)
{
...
void IPv6NeighbourDiscoveryRPL::processRAPacket(IPv6RouterAdvertisement *ra,
...
void IPv6NeighbourDiscoveryRPL::processRAForRouterUpdates(IPv6RouterAdvertisement *ra,
        IPv6ControlInfo *raCtrlInfo)
{
...
void IPv6NeighbourDiscoveryRPL::processRAPrefixInfo(IPv6RouterAdvertisement *ra,
        InterfaceEntry *ie)
{
...
#ifndef WITH_xMIPv6
void IPv6NeighbourDiscoveryRPL::processRAPrefixInfoForAddrAutoConf(IPv6NDPrefixInformation& prefixInfo, InterfaceEntry *ie)
{
...
void IPv6NeighbourDiscoveryRPL::createRATimer(InterfaceEntry *ie)
{
...
void IPv6NeighbourDiscoveryRPL::resetRATimer(InterfaceEntry *ie)
...
void IPv6NeighbourDiscoveryRPL::sendPeriodicRA(cMessage *msg)
{
    InterfaceEntry *ie = (InterfaceEntry *)msg->getContextPointer();
...
void IPv6NeighbourDiscoveryRPL::sendSolicitedRA(cMessage *msg)
{
...
bool IPv6NeighbourDiscoveryRPL::validateRAPacket(IPv6RouterAdvertisement *ra,
        IPv6ControlInfo *raCtrlInfo)
{
    bool result = true;
...
void IPv6NeighbourDiscoveryRPL::processNSPacket(IPv6NeighbourSolicitation *ns,
...
bool IPv6NeighbourDiscoveryRPL::validateNSPacket(IPv6NeighbourSolicitation *ns,
        IPv6ControlInfo *nsCtrlInfo)
{
    bool result = true;
...
void IPv6NeighbourDiscoveryRPL::processNSForTentativeAddress(IPv6NeighbourSolicitation *ns,
        IPv6ControlInfo *nsCtrlInfo)
{
    //Control Information
...
void IPv6NeighbourDiscoveryRPL::processNSForNonTentativeAddress(IPv6NeighbourSolicitation *ns,
...
void IPv6NeighbourDiscoveryRPL::processNAPacket(IPv6NeighbourAdvertisement *na,
...
bool IPv6NeighbourDiscoveryRPL::validateNAPacket(IPv6NeighbourAdvertisement *na,
        IPv6ControlInfo *naCtrlInfo)
{
...
void IPv6NeighbourDiscoveryRPL::processNAForIncompleteNCEState(IPv6NeighbourAdvertisement *na, Neighbour *nce)
{
...
void IPv6NeighbourDiscoveryRPL::processNAForOtherNCEStates(IPv6NeighbourAdvertisement *na, Neighbour *nce)
{
    bool naRouterFlag = na->getRouterFlag();
    bool naSolicitedFlag = na->getSolicitedFlag();
...
IPv6Redirect *IPv6NeighbourDiscoveryRPL::createAndSendRedirectPacket(InterfaceEntry *ie)
{
...
void IPv6NeighbourDiscoveryRPL::processRedirectPacket(IPv6Redirect *redirect,
...
void IPv6NeighbourDiscoveryRPL::processRAPrefixInfoForAddrAutoConf(IPv6NDPrefixInformation& prefixInfo, InterfaceEntry *ie, bool hFlag)
{
    EV_INFO << "Processing Prefix Info for address auto-configuration.\n";
    IPv6Address prefix = prefixInfo.getPrefix();
    uint prefixLength = prefixInfo.getPrefixLength();
...
void IPv6NeighbourDiscoveryRPL::routersUnreachabilityDetection(const InterfaceEntry *ie)
{
...
void IPv6NeighbourDiscoveryRPL::invalidateNeigbourCache()
{
    //Enter_Method("Invalidating Neigbour Cache Entries");
    neighbourCache.invalidateAllEntries();
}

bool IPv6NeighbourDiscoveryRPL::canServeWirelessNodes(InterfaceEntry *ie)
{
...
bool IPv6NeighbourDiscoveryRPL::isWirelessInterface(const InterfaceEntry *ie)
{
    // TODO should be a flag in the InterfaceEntry
    return strncmp("wlan", ie->getName(), 4) == 0;
}

bool IPv6NeighbourDiscoveryRPL::isWirelessAccessPoint(cModule *module)
{
