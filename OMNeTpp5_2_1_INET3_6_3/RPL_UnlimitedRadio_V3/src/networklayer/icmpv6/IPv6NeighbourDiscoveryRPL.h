...
#ifndef _RPL_SRC_NETWORKLAYER_ICMPV6_IPV6NEIGHBOURDISCOVERYRPL_H
#define _RPL_SRC_NETWORKLAYER_ICMPV6_IPV6NEIGHBOURDISCOVERYRPL_H
...
class IPv6NeighbourDiscoveryRPL : public cSimpleModule, public ILifecycle
{
  ...
  public:
    ...
    virtual ~IPv6NeighbourDiscoveryRPL();
  ...
  protected:
    ...
    bool staticAddressAssignment; //EXTRA : assume that Link Local address is assigned statically
...
//EXTRA END
  ...
  public:
    virtual Neighbour *addNeighborFromRPLMessage(IPv6ControlInfo *ctrlInfo); //EXTRA
protected:
    virtual bool handleOperationStage(LifecycleOperation *operation, int stage, IDoneCallback *doneCallback) override;
    virtual void finish() override;

    virtual void processIPv6Datagram(IPv6Datagram *datagram);
    virtual IPv6NeighbourDiscoveryRPL::AdvIfEntry *fetchAdvIfEntry(InterfaceEntry *ie);
    virtual IPv6NeighbourDiscoveryRPL::RDEntry *fetchRDEntry(InterfaceEntry *ie);
...
#endif    //_RPL_SRC_NETWORKLAYER_ICMPV6_IPV6NEIGHBOURDISCOVERYRPL_H
