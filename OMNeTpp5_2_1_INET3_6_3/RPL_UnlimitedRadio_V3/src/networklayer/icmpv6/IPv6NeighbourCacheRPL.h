...
#ifndef _RPL_SRC_NETWORKLAYER_ICMPV6_IPV6NEIGHBOURCACHERPL_H
#define _RPL_SRC_NETWORKLAYER_ICMPV6_IPV6NEIGHBOURCACHERPL_H
...
class IPv6NeighbourCacheRPL
{
  ...
  public:
    IPv6NeighbourCacheRPL(cSimpleModule& neighbourDiscovery);
    virtual ~IPv6NeighbourCacheRPL() {}
...
#endif // ifndef _RPL_SRC_NETWORKLAYER_ICMPV6_IPV6NEIGHBOURCACHERPL_H
