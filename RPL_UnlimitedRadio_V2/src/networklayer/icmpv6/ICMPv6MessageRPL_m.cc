...
std::string ICMPv6DISMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 10: return enum2string(pp->getOptions(), "inet::RPL_DIS_OPTIONS");
        default: return "";
    }
}
...
bool ICMPv6DISMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 10: pp->setOptions((inet::RPL_DIS_OPTIONS)string2enum(value, "inet::RPL_DIS_OPTIONS")); return true;
